...
$ rake paper:admission
$ rake paper:spider


== Deploying

The deploy process is based on capistrano and foreman. Before deploying, create a file called servers.rb at the root of the project. In this file, you should set which is your redis_hostname and list your servers as you would with capistrano, using the :foreman role for your resque-web instance and workers. For example:
